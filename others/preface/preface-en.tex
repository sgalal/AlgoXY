...
is to find the 1,500th number, which only contains factor 2, 3 or 5\footnote{TODO: add footnote about regular number}.
...
support model the lazy evaluation with stream, The above infinity series functions can be translate into the following program.
