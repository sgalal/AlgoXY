...
Denote the balance factor of the parent node as $\Delta$, by checking the new value
$\Delta'$, there are three different cases.

\begin{itemize}
\item Case 1, $|\Delta| = 0$, $|\Delta'| = 1$. It means, after deletion, although
the sub tree height shrinks, the parent node still satisfies the AVL property. The
